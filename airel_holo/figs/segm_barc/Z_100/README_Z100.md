...
Test-set results for the shallowest reconstruction depth: **100 planes = 50 µm**.
...
Naming: `<type>_<architecture>_Z100_Nb<density>.<ext>`
...
python3.10 plot_paper_figure.py \
    --arch  configs/Z100_20b/architecture_base_z10.yaml \
    --input configs/Z100_20b/input_z10_p8.yaml \
    --cache_split test \
    --out_dir figs_Z100_20b
```
